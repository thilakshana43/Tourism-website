...
public class book extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String children=request.getParameter("children");
         ...
         String SQL="INSERT INTO booking ( `Destination`, `Check_In`, `Check_Out`, `Rooms`, `Adults`, `Children`)VALUES('"+destination+"','"+checkin+"','"+checkout+"','"+room+"','"+adults+"','"+children+"')";
        ...
        try
        {
            ...
            RequestDispatcher r = request.getRequestDispatcher("Rsuccess.jsp");
